...
$sql="select blog_id, blog_title, YEAR(release_time) as release_year, DATE_FORMAT(release_time, '%m-%d') as release_date, release_time from blog order by release_time desc";
