...
if ($_SESSION['user_id']=='1'){
    ...
    $sub_button="<input class=\"btn btn-default\" style=\"float: right; \" type=\"submit\" disabled value=\"关注\">";
}
else{
    ...
    $sub_button="<input class=\"btn btn-default\" style=\"float: right; \" type=\"submit\" value=\"关注\">";
}

$sql="select * from news_platform";
$result=mysqli_query($conn, $sql);
$news_platform_array=array();
$news_subscribtion_array=array();
if(!$result){
    echo "没有平台";
    $news_platform_num=0;
}
    ...
    for($i=0;$i<$news_platform_num;$i++){
        $news_platform_array[$i]=mysqli_fetch_assoc($result);
        $news_subscribtion_array[$news_platform_array[$i]['news_platform_id']]='0';
    }
}

$sql="select * from news_subscribtion where user_id=". $_SESSION['user_id'];
$result=mysqli_query($conn,$sql);
if(!$result){
    echo "没有订阅";
}
while($news_subscribtion=mysqli_fetch_assoc($result)){
    $news_subscribtion_array[$news_subscribtion['news_platform_id']]='1';
}
        ...
        <div class="header-inner">
            ...
            <nav class="site-nav">
                <ul id="menu" class="menu">
                    ...
                    <li class="menu-item menu-item-platform menu-item-active" style="opacity: 1; transform: translateY(0px);">
                        <a href="#" rel="section">
                        ...
                        <form action="./backend/regis.php" method="post" onsubmit="return regisCheck()">
                            <div class="local-login-body">
                                ...
                                <div class="form-group" style="margin-top:20px;">
                                    ...
                                    <button type="submit" class="btn btn-block btn-default" id="regis_btn" name="regis_btn" disabled="true" style="float: right;">验证并注册</button>
                                </div>
                            </div>
                        </form>
                    </div>
                ...
                <div id="content" class="content">
                    <section id="posts" class="posts-expand">
                        <header class="post-header" style="opacity: 1; display: block; transform: translateY(0px);">
                            <h1 class="post-title" itemprop="name headline">所有新闻平台</h1>
                        </header>
                        <div class="category-all-platform">
                            <div class="category-all-title">
                                目前共<?php echo $news_platform_num;?>个新闻平台
                            </div>
                            <div class="category-all">
                                <ul class="category-list">
                                    <?php
                                    foreach ($news_platform_array as $news_platform){
                                        if ($news_subscribtion_array[$news_platform['news_platform_id']]=='1'){
                                            $sub_button="<input class=\"btn btn-default\" style=\"float: right; \" type=\"submit\" disabled value=\"已关注\">";
                                        }
                                        elseif ($news_subscribtion_array[$news_platform['news_platform_id']]=='0'){
                                            $sub_button="<input class=\"btn btn-default\" style=\"float: right; \" type=\"submit\" value=\"关注\">";
                                        }
                                        ...
                                        <div class=\"post clearfix\">
                                            <div class=\"user-block\" style=\"margin-bottom: 15px;\">
                                                ...
                                                <form method=\"get\" action=\"./backend/news_subscrib.php\">
