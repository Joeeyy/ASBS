...
$blog_type=$_GET['blog_type'];
$sql="select blog_id, blog_title, YEAR(release_time) as release_year, DATE_FORMAT(release_time, '%m-%d') as release_date, release_time from blog natural join blog_types where blog_type_name='". $blog_type. "' order by release_time desc";
                        ...
                        <form action="./backend/login.php" method="post" onsubmit="return loginCheck()">
                            <div class="local-login-body">
                                ...
                                <div class="form-group" style="margin-top:20px;">
                                    ...
                                    <button type="submit" class="btn btn-block btn-default" id="login_btn" name="login_btn" disabled="true" style="float: right;">验证并登录</button>
                                </div>
                            </div>
                        </form>
                    </div>
                    ...
                    <div class="post-block archive" style="opacity: 1; display: block;">
                        <div id="posts" class="posts-collapse">
                            ...
                            <span class="archive-page-counter">
                                <?php echo "【".$blog_type. "】类型下";?> 目前共计 <?php echo $blog_num;?> 篇日志。 继续努力。
                            </span>
                            <?php
                            $year='0';
                            for ($i=0;$i<$blog_num;$i++){
