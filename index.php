...
$sql="select * from blog natural join user natural join blog_types order by release_time desc";
                                    ...
                                    <div class="local-login-body">
                                        <div class="form-group">
                                            ...
                                            <span class="form-item">
                                                <input placeholder="请输入用户名" required maxlength="12" id="login-username" name="login-username">
                                            </span>
                                        </div>
                                        <div class="form-group">
                                ...
                                for($i=0;$i<$blog_num;$i++) {
                                    ...
                                    <div class=\"post-block\" style=\"opacity: 1; display: block;\">
                                        ...
                                        <span hidden=\"\" itemprop=\"author\" itemscope=\"\" itemtype=\"http://schema.org/Person\">
                                            <meta itemprop=\"name\" content=\"" . $blog_array[$i]['user_name'] . "\">
                                            <meta itemprop=\"description\" content=\"\">
                                            <meta itemprop=\"image\" content=\"imagepath\">
                                        </span>
                                        <span hidden=\"\" itemprop=\"publisher\" itemscope=\"\" itemtype=\"http://schema.org/Organization\">
                                            <meta itemprop=\"name\" content=\"ASBS\">
                                        </span>
                                        <header class=\"post-header\" style=\"opacity: 1; display: block; transform: translateY(0px);\">
                                            <h1 class=\"post-title\" itemprop=\"name headline\">
                                                <a class=\"post-title-link\" href=\"./article.php?blog_id=" . $blog_array[$i]['blog_id'] . "\" itemprop=\"url\">". $blog_array[$i]['blog_title']."</a>
                                            </h1>
                                            <div class=\"post-meta\">
                                                <span class=\"post-time\">
                                                    ...
                                                    <a class=\"post-meta-item-text\" href=\"./user.php?user_id=". $blog_array[$i]['user_id']. "\">". $blog_array[$i]['user_name'] ."</a>
                                                    <span class=\"post-meta-item-text\">发表于</span>
                                                    <time title=\"创建于\" itemprop=\"dateCreated datePublished\" datetime=\"". $blog_array[$i]['release_time']. "+08:00\">".
                                                        $blog_array[$i]['release_time'].
                                                    "</time>
                                                </span>
                                                <span class=\"post-category\">
                                                    ...
                                                    <span class=\"about\" itemscope itemtype=\"http://schema.org/Thing\">
                                                        <a href=\"./articlesofcategory.php?blog_type=".$blog_array[$i]['blog_type_name']."\" itemprop=\"url\" rel=\"index\">
                                                            <span itemprop=\"name\">". $blog_array[$i]['blog_type_name']. "</span>
                                                        </a>
                                                    </span>
                                                </span>
                                                <span id=\"./article.php?blog_id=" . $blog_array[$i]['blog_id'] . "\" class=\"leancloud_visitors\">
                                                    <span class=\"post-meta-divider\">|</span>
                                                    <span class=\"post-meta-item-icon\">
                                                        <i class=\"fa fa-eye\"></i>
                                                    </span>
                                                    <span class=\"post-meta-item-text\">阅读次数:</span>
                                                    <span class=\"leancloud-visitors-count\">". $blog_array[$i]['read_count']."</span>
                                                </span>
                                            </div>
                                        </header>
                                        <div class=\"post-body\" itemprop=\"articelBody\" style=\"opacity: 1; display: block; transform: translateY(0px);\">".
                                            $blog_array[$i]['blog_content'].
                                            "<!--noindex-->
                                            <div class=\"post-button text-center\">
                                                <a class=\"btn\" href=\"./article.php?blog_id=" . $blog_array[$i]['blog_id'] . "\" rel=\"contents\">
                                                    阅读全文 »
                                                </a>
                                            </div>
                                            <!--/noindex-->
