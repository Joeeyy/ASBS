...
$blog_tag=$_GET['blog_tag'];
$sql="select blog_id, blog_title, YEAR(release_time) as release_year, DATE_FORMAT(release_time, '%m-%d') as release_date, release_time from blog where tags like '%". $blog_tag. "%' order by release_time desc";
                    ...
                    <div class="post-block archive" style="opacity: 1; display: block;">
                        <div id="posts" class="posts-collapse">
                            ...
                            <span class="archive-page-counter">
                                <?php echo "【". $blog_tag. "】标签下";?> 目前共计 <?php echo $blog_num;?> 篇日志。 继续努力。
                            </span>
                            <?php
                            $year='0';
                            for ($i=0;$i<$blog_num;$i++){
