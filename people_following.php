...
if(!$result){
    //echo "没有订阅";
    $follow_num=$result->num_rows;
}
else{
    $follow_num=$result->num_rows;
    $i=0;
    while($follow=mysqli_fetch_assoc($result)){
        $sql = "select * from user where user_id=". $follow['befollowed_user_id'];
        $result = mysqli_query($conn, $sql);
                ...
                <div id="content" class="content">
                    <section id="posts" class="posts-expand">
                        <header class="post-header" style="opacity: 1; display: block; transform: translateY(0px);">
                            <h1 class="post-title" itemprop="name headline">关注的人</h1>
                        </header>
                        <div class="category-all-platform">
                            <div class="category-all-title">
                                目前共关注<?php echo $follow_num;?>名用户
                            </div>
                                        ...
                                        <div class=\"post clearfix\">
                                            <div class=\"user-block\" style=\"margin-bottom: 15px;\">
                                                ...
                                                <span class=\"site-title\" style=\"opacity: 1;\">
                                                    <img class=\"img-circle\" src=\"./images/user/user_default.jpeg\">
                                                    <a href='./user.php?user_id=". $follow['user_id']."' class=\"iconfont\" style=\"font-size: 25px; margin-left: 5px;\">". $follow['user_name']. "</a>
                                                </span>
                                                <span class=\"logo-line-after\"><i></i></span>
                                                <form method=\"get\" action=\"./backend/followship_cancel.php\">
                                                    <input hidden name=\"befollowed_user_id\" id=\"befollowed_user_id\" value=\"". $follow['user_id']. "\">
                                                    <input hidden name=\"user_id\" id=\"user_id\" value=\"". $_SESSION['user_id']."\">
                                                    <input class=\"btn btn-default\" style=\"float: right; \" type=\"submit\" value=\"取消关注\">
                                                </form>
                                            </div>
